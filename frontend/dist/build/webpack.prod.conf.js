...
var GeneraterAssetPlugin = require('generate-asset-webpack-plugin');
var serverConfig = require('../serverConfig.json');

var env = process.env.NODE_ENV === 'testing' ? require('../config/test.env') : require('../config/prod.env');

var createJson = function createJson(compilation) {
  return (0, _stringify2.default)(serverConfig);
};
